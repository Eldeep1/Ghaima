...
import java.util.Locale
    ...
    fun WeatherForeCastDTO.toWeatherForecastModel(
        ...
        return WeatherForecastModel(
            ...
            hourlyForecast = this.list.take(8).map { it.toHourlyWeather(sourceTempUnit,targetTempUnit) },
    ...
    private fun Data.toHourlyWeather(sourceTemp: TemperatureUnit, targetTemp: TemperatureUnit): HourlyWeatherModel {
    ...
    private fun List<Data>.toDailyWeather(sourceTemp: TemperatureUnit, targetTemp: TemperatureUnit): List<DailyWeatherModel> {
        return this.groupBy { it.dt.formatUnixDate("yyyy-MM-dd") }
            .map { (_, dailyDataList) ->
                ...
                val midDayWeather = dailyDataList.firstOrNull { it.dtTxt.contains("12:00:00") } ?: dailyDataList.first()
